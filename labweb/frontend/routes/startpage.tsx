...
// function StartPage() {
//   return (
//     <div className="w-4/5 text-xl text-left text-secondary font-primaryfont"><h1 className='text-4xl font-medium text-center text-secondary font-logofont'>Motion Tracker Lab</h1>
//     <br>
//     </br>
